...
export default function Part4({ answers, setAnswer, currentQ, setCurrentQ, qRefs }) {
  ...
  return (
    <div className="mx-auto w-full px-4 text-[15px] text-black pb-20">
      ...
      <h3 className="font-bold text-[19px] mb-4">Tardigrades</h3>
      <ul className="list-disc pl-6 mb-8 space-y-4 text-[17px] text-black">
      ...
      <div className="mb-8">
        <div className="font-bold mb-4 text-[17px]">Physical appearance</div>
      ...
      <div className="mb-8">
        <div className="font-bold mb-4 text-[17px]">Habitat</div>
        <ul className="list-disc pl-6 space-y-4 text-[17px] text-black">
      ...
      <div className="mb-8">
        <div className="font-bold mb-4 text-[17px]">Cryptobiosis</div>
        <ul className="list-disc pl-6 space-y-4 text-[17px] text-black">
      ...
      <div className="mb-8">
        <div className="font-bold mb-4 text-[17px]">Feeding</div>
        <ul className="list-disc pl-6 space-y-4 text-[17px] text-black">
          <li>
            <div className="flex items-center flex-wrap gap-y-2">
      ...
      <div>
        <div className="font-bold mb-4 text-[17px]">Conservation status</div>
        <ul className="list-disc pl-6 space-y-4 text-[17px] text-black">
          <li>
            <div className="flex items-center flex-wrap gap-y-2">
