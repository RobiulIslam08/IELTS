...
export default function Part4({ answers, setAnswer, currentQ, setCurrentQ, qRefs }) {
  ...
  return (
    <div className="mx-auto w-full px-4 pb-24 text-[15px] text-black">
      <div className="mb-6">
        <h2 className="mb-1 text-[17px] font-bold">Questions 31–40</h2>
        <p className="text-[17px]">
          Complete the notes. Write <span className="font-bold">ONE WORD ONLY</span> for each answer.
        </p>
      </div>

      <div className="space-y-5">
        {Array.from({ length: 10 }, (_, idx) => idx + 31).map((q) => (
