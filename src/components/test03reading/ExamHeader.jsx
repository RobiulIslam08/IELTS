  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 shrink-0 mb-2 border-b">
      <div className="flex items-center gap-6 sm:gap-10">
        ...
        <div className="grid gap-2 content-center justify-items-start text-[17px] text-black font-bold">
          <span>Test taker ID</span>
        </div>

        {/* Countdown Timer (driven by parent) */}
        <div className="text-[17px] text-black font-bold flex items-center gap-1">
          Time left:{" "}
