    ...
    <header className="flex items-center justify-between px-4 py-3 shrink-0 mb-2  border-b border-gray-300">
      <div className="flex items-center gap-8">
         <div className="flex items-center font-black">
              <img className="object-contain w-[92px]" src="/ielts.svg" alt="" />
            </div>
            ...
            <div className="text-[17px] text-black font-bold ml-2">
              Time left: <span className={`font-black ${isLowTime ? "text-rose-600 animate-pulse" : "text-gray-800"}`}>{minutes}:{seconds}</span>
            </div>
      </div>
      <div className="flex items-center gap-8 ">
